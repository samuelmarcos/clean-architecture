...
import { 
    ...
    HashCompare } from "./db.authentication.protocols"
...
import { mockAthenticationModel } from '@/mocks/domain'
...
describe('Db Athentication', () => {
    test('should call LoadAccountByEmailRepository with correct email', async () => {
        ...
        await sut.auth(mockAthenticationModel())
        expect(loadSpy).toHaveBeenLastCalledWith(mockAthenticationModel().email)
    })
    ...
    test('should throw if LoadAccountByEmailRepository throws', async () => {
        ...
        const promise = sut.auth(mockAthenticationModel())
    ...
    test('should return null if LoadAccountByEmailRepository returns null', async () => {
        ...
        const accessToken = await sut.auth(mockAthenticationModel())
    ...
    test('should call Encrypter returns a token os sucess', async () => {
        ...
        const {sut} = makeSut()
        const acess_token = await sut.auth(mockAthenticationModel())
